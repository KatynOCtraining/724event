...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // Passer newValue au gestionnaire onChange
    setValue(newValue);
    setCollapsed(true); // Il semble que vous vouliez replier le menu après une sélection, donc true est correct ici
  };
